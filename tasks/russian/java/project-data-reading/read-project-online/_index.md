---
date: 2026-02-18
description: Узнайте, как читать данные MS Project Online с помощью Aspose.Tasks для
  Java. В этом руководстве показано, как получить список проектов, список проектов
