...
## 24bppRgb फ़ॉर्मेट का इस्तेमाल क्यों करें?
...
### स्टेप 3: इमेज सेव ऑप्शन कॉन्फ़िगर करें
```java
...
### स्टेप 4: प्रोजेक्ट डेटा को इमेज के तौर पर सेव करें
```java
