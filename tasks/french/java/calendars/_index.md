...
- **Existe-t-il un projet d'exemple pour commencer ?**  
  Le tutoriel « Define Weekdays in Calendar » lié ci‑dessous comprend un exemple prêt à être exécuté.

## Qu’est‑ce que la « définition des jours de la semaine » dans MS Project ?
Définir les jours de la semaine consiste à préciser quels jours de la semaine sont considérés comme jours ouvrés et à attribuer les heures de début/fin, les règles de temps supplémentaire ou les exceptions pour chaque jour. Ces informations pilotent la planification des tâches, l’allocation des ressources et les calculs du chemin critique tout au long du cycle de vie du projet.

## Pourquoi utiliser Aspose.Tasks for Java pour définir les jours de la semaine ?
- **Contrôle complet de l'API** – Pas de limitations d'interface ; vous pouvez créer, modifier ou supprimer des entrées de jours de la semaine de manière programmatique.
- **Cross‑platform** – Fonctionne sur tout environnement compatible JVM, des applications de bureau aux services cloud.
- **Précision** – Définissez des horaires de travail différents pour chaque jour de la semaine, ajoutez des exceptions pour les vacances et synchronisez les calendriers entre plusieurs projets.
- **Performance** – Manipulez de gros fichiers de projet sans charger l'intégralité de l'interface, idéal pour les pipelines automatisés.
...
- Une licence Aspose.Tasks valide (une licence d'évaluation suffit pour l'apprentissage).

## Gérer les propriétés du calendrier MS Project avec Aspose.Tasks
...
Prêt à créer des calendriers facilement ? [Consultez le tutoriel](./create/).

## Définir les jours de la semaine dans le calendrier avec Aspose.Tasks
Personnalisez vos calendriers MS Project en définissant les jours de la semaine avec Aspose.Tasks for Java. Ce tutoriel vous guide à travers le processus d'adaptation des jours ouvrés et des horaires, vous offrant la flexibilité nécessaire pour une gestion de projet réussie. Faites en sorte que vos calendriers travaillent pour vous.

Prêt à définir les jours de la semaine sans effort ? [Commencez ici](./define-weekdays/).

En parcourant ces tutoriels, vous découvrirez des sujets supplémentaires couvrant l'extraction des heures de travail, la création de calendriers standard, la lecture des semaines de travail et la mise à jour des calendriers au format MPP. Chaque tutoriel est conçu pour vous fournir des connaissances pratiques, vous permettant d'appliquer directement ce que vous apprenez à vos projets Java.

## Obtenir les heures de travail depuis le calendrier avec Aspose.Tasks
Simplifiez vos tâches de gestion de projet en extrayant les heures de travail des calendriers MS Project avec Aspose.Tasks for Java. Ce tutoriel vous fournit les compétences nécessaires pour optimiser efficacement vos échéances de projet.
...
Prêt à créer un calendrier standard ? [Consultez le tutoriel](./make-standard/).

## Lire les semaines de travail depuis le calendrier MS Project avec Aspose.Tasks
Obtenez des informations complètes sur la lecture des semaines de travail depuis les calendriers MS Project avec Aspose.Tasks for Java. Ce tutoriel offre des instructions détaillées, vous permettant de gérer efficacement les plannings de votre projet.
...
Débloquez tout le potentiel d'Aspose.Tasks for Java et améliorez vos compétences en gestion de projet. Chaque tutoriel est conçu pour les développeurs de tous niveaux, assurant une expérience d'apprentissage fluide. Plongez‑y et révolutionnez dès aujourd'hui votre parcours de gestion de projet Java !

## Tutoriels sur les calendriers
### [Manage MS Project Calendar Properties in Aspose.Tasks](./properties/)
Apprenez à gérer les propriétés du calendrier MS Project en Java avec Aspose.Tasks. Cela fournit des instructions pas à pas pour le calendrier au sein de vos applications Java.
...
Extrayez les heures de travail des calendriers MS Project facilement avec Aspose.Tasks for Java. Simplifiez les tâches de gestion de projet.
...
Apprenez à lire les semaines de travail depuis le calendrier MS Project avec Aspose.Tasks for Java. Obtenez des instructions pas à pas dans ce tutoriel complet.
### [Update MS Project Calendars to MPP Format with Aspose.Tasks](./update-to-mpp/)
Apprenez à mettre à jour les calendriers MS Project au format MPP facilement avec Aspose.Tasks for Java.
...
**Q : Comment gérer les vacances ou les jours non ouvrés ?**  
R : Après avoir défini les jours de la semaine, vous pouvez ajouter des exceptions (dates) pour marquer les vacances ou des périodes non ouvrées personnalisées.
...
R : Toutes les versions récentes (20.10 et suivantes) prennent en charge les API complètes des jours de la semaine. Nous recommandons d’utiliser la dernière version stable pour des performances optimales.
