...
linktitle: Сбор представлений в Aspose.Tasks
...
### Как я могу получить поддержку сообщества для Aspose.Tasks?
 Взаимодействуйте с сообществом Aspose.Tasks на[Форум](https://forum.aspose.com/c/tasks/15) для любых вопросов или помощи.
