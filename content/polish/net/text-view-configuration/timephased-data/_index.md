...
W projekcie .NET pamiętaj o zaimportowaniu niezbędnych przestrzeni nazw, aby wykorzystać funkcje Aspose.Tasks. Dodaj następujące wiersze na początku pliku kodu:
```csharp
    using Aspose.Tasks;
    using System;
