...
इस ट्यूटोरियल में, हम जानेंगे कि Aspose में कैलेंडर अपवादों को कैसे प्रबंधित किया जाए। .NET फ्रेमवर्क का उपयोग करके कार्य। कैलेंडर अपवाद हमें प्रोजेक्ट कैलेंडर में विशेष तिथियों या अवधियों को परिभाषित करने की अनुमति देते हैं जहां नियमित कामकाजी शेड्यूल बदल दिया जाता है, जैसे छुट्टियां या अस्थायी बंद। हम .NET के लिए Aspose.Tasks का उपयोग करके चरण दर चरण कैलेंडर अपवादों को संभालने के विभिन्न तरीकों को कवर करेंगे।
