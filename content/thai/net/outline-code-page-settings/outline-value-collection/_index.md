...
description: เรียนรู้วิธีจัดการค่าโครงร่างในไฟล์ Microsoft Project โดยใช้ Aspose.Tasks สำหรับ .NET บทช่วยสอนทีละขั้นตอนพร้อมตัวอย่างโค้ด
type: docs
weight: 17
url: /th/net/outline-code-page-settings/outline-value-collection/
---
## การแนะนำ
Aspose.Tasks สำหรับ .NET มีชุดคุณลักษณะที่ครอบคลุมเพื่อโต้ตอบกับไฟล์ Microsoft Project คุณสมบัติอย่างหนึ่งคือความสามารถในการจัดการค่าโครงร่างภายในโปรเจ็กต์ ในบทช่วยสอนนี้ เราจะสำรวจวิธีการรวบรวมและจัดการค่าโครงร่างโดยใช้ Aspose.Tasks สำหรับ .NET
## ข้อกำหนดเบื้องต้น
...
ดำเนินการต่างๆ เช่น การลบ การแทรก และการคัดลอกค่าโครงร่างตามต้องการ:
```csharp
...
ตอบ: ได้ Aspose.Tasks มี API มากมายเพื่อปรับแต่งรูปลักษณ์และการทำงานของค่าเค้าร่างตามความต้องการของคุณ
